 ...
 * {@link #getInstance} will return a {@link com.galix.avcore.util.SystemUiHiderHoneycomb} instance,
...
public abstract class SystemUiHider {
	...
	/**
	 * Creates and returns an instance of {@link com.galix.avcore.util.SystemUiHider} that is
	 * appropriate for this device. The object will be either a
	 * {@link SystemUiHiderBase} or {@link com.galix.avcore.util.SystemUiHiderHoneycomb} depending on
	 * the device.
	 * 
	 * @param activity
	 ...
	 */
	public static com.galix.avcore.util.SystemUiHider getInstance(Activity activity, View anchorView,
                                                                  int flags) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			return new com.galix.avcore.util.SystemUiHiderHoneycomb(activity, anchorView, flags);
		} else {
