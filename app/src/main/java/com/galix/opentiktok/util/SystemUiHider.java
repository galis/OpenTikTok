 ...
 * {@link #getInstance} will return a {@link com.galix.opentiktok.util.SystemUiHiderHoneycomb} instance,
...
public abstract class SystemUiHider {
	...
	/**
	 * Creates and returns an instance of {@link com.galix.opentiktok.util.SystemUiHider} that is
	 * appropriate for this device. The object will be either a
	 * {@link SystemUiHiderBase} or {@link com.galix.opentiktok.util.SystemUiHiderHoneycomb} depending on
	 * the device.
	 * 
	 * @param activity
	 ...
	 */
	public static com.galix.opentiktok.util.SystemUiHider getInstance(Activity activity, View anchorView,
                                                                          int flags) {
		if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
			return new com.galix.opentiktok.util.SystemUiHiderHoneycomb(activity, anchorView, flags);
		} else {
